...
def train(dataset, n_feature, learning_rate, bs, columns_sel, mfs_type=MfsType.Gauss):
    ...
    load_model.metrics(dataset, columns_sel, mfs_type, device)
    return model
...
for dataset_name in dataset_names:
    ...
    model = train(dataset_name, n_features, params.get('lr'), params.get('batch_size'), columns_sel[:n_features], mfs_type=MfsType.Gauss)
    model = train(dataset_name, n_features, params.get('lr'), params.get('batch_size'), columns_sel[:n_features], mfs_type=MfsType.Bell)
    model = train(dataset_name, n_features, params.get('lr'), params.get('batch_size'), columns_sel[:n_features], mfs_type=MfsType.Gauss)